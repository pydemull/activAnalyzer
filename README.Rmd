...
For now, this app can be used following two different ways: (i) on the web via a [shinyapps.io plateform](https://pydemull.shinyapps.io/activAnalyzer/); (ii) on PC after installing R software and the activAnalyzer package.
