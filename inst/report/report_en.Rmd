...
**PROactive amount scores (for COPD patients):** Step count score = `r compute_pro_actigraph_score(df1_medians[["total_steps"]], metric = "steps")` (daily median of `r df1_medians[["total_steps"]]` steps);  VMU score = `r compute_pro_actigraph_score(df1_medians[["vm_per_min"]], metric = "vm")` (daily median of `r df1_medians[["vm_per_min"]]` counts/min).
