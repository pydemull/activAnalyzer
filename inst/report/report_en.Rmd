...
# Defining PAL status
  pal_status <- ifelse(df1_means[["pal"]] <1.40, "below the 'Sedentary or light activity lifestyle' category",
...
# Ratio MVPA / SED comment
  comment_ratio <- 
    ifelse(df1_means[["ratio_mvpa_sed"]] >= 0.04, "the patient likely already has most of the health benefits from their physical behavior",
