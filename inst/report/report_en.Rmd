...
**Period analyzed to assess valid wear time each day:** from `r params$start_day_analysis` to `r params$end_day_analysis`.

**Minimum number of hours with valid wear time to validate a day**: `r params$minimum_wear_time_for_analysis` hours.
