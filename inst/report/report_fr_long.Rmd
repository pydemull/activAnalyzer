...
reactable::reactable(
  tibble::tibble(
        ...
        "Moyenne | m\xc3\xa9diane journali\xc3\xa8re obtenue \xc3\xa0 partir des jours valides" = c(
          ...
          # Total Axis 1
          paste0(format(round(df1_means[["total_counts_axis1"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_means[["total_counts_axis1"]]), ") | ",  
                 format(round(df1_medians[["total_counts_axis1"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_medians[["total_counts_axis1"]]), ")"), 
          
          # Total VM
          paste0(format(round(df1_means[["total_counts_vm"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_means[["total_counts_vm"]]), ") | ",  
                 format(round(df1_medians[["total_counts_vm"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_medians[["total_counts_vm"]]), ")"), 
          ...
          # Minutes MPA
          paste0(format(round(df1_means[["minutes_MPA"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_means[["minutes_MPA"]]), ") | ",  
                 format(round(df1_medians[["minutes_MPA"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_medians[["minutes_MPA"]]), ")"),
          
          # Minutes VPA
          paste0(format(round(df1_means[["minutes_VPA"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_means[["minutes_VPA"]]), ") | ",  
                 format(round(df1_medians[["minutes_VPA"]], 1), nsmall = 1), " min (", hms::hms(minutes = df1_medians[["minutes_VPA"]]), ")"),
...
reactable::reactable(
  tibble::tibble(
        ...
        "Moyenne | m\xc3\xa9diane journali\xc3\xa8re obtenue \xc3\xa0 partir des jours valides" = c(
          ...
          # M1/3
            paste0(format(round(df1_means[["M1/3"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M1/3"]], 1), nsmall = 1), " counts/", params$epoch, "s"), 

          # M120
            paste0(format(round(df1_means[["M120"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M120"]], 1), nsmall = 1), " counts/", params$epoch, "s"), 
                    
          # M60
            paste0(format(round(df1_means[["M60"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M60"]], 1), nsmall = 1), " counts/", params$epoch, "s"), 
                    
          # M30
            paste0(format(round(df1_means[["M30"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M30"]], 1), nsmall = 1), " counts/", params$epoch, "s"),
                    
          # M15
            paste0(format(round(df1_means[["M15"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M15"]], 1), nsmall = 1), " counts/", params$epoch, "s"), 
                    
          # M5
            paste0(format(round(df1_means[["M5"]], 1), nsmall = 1), " counts/", params$epoch, "s | ",
                   format(round(df1_medians[["M5"]], 1), nsmall = 1), " counts/", params$epoch, "s")
