...
if(length(params$p_breaks_pa) == 1) {
  ...
  p1 <- params$p_alpha_sed + labs(x = "Durée de période (min)", color = "Durée (min)", fill = "Durée (min)") + theme(legend.position = "none")
  p2 <- params$p_MBD_sed  + labs(x = "Durée de période (min)", color = "Durée (min)", fill = "Durée (min)") + theme(legend.position = "none")
...
if(length(params$p_breaks_pa) == 1) {
  ...
  p1 <- params$p_alpha_pa + labs(x = "Durée de période (min)", color = "Durée (min)", fill = "Durée (min)") + theme(legend.position = "none")
  p2 <- params$p_MBD_pa  + labs(x = "Durée de période (min)", color = "Durée (min)", fill = "Durée (min)") + theme(legend.position = "none")
