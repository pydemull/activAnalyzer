...
# PAL
g_pal <- create_fig_pal(score = df1_means[["pal"]], "fr")

# Steps
g_steps <- create_fig_steps(score = df1_means[["total_steps"]], "fr")

if (params$rendered_by_shiny)
  shiny::setProgress(0.5)  # set progress to 50%

# MVPA
g_mvpa <- create_fig_mvpa(score = df1_means[["minutes_MVPA"]], "fr")

# SED
g_sed <- create_fig_sed(score = df1_means[["minutes_SED"]], "fr")

# MVPA/SED ratio
g_ratio <- create_fig_ratio_mvpa_sed(score = df1_means[["ratio_mvpa_sed"]], "fr")
