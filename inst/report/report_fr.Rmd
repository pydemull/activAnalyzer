...
**Abréviations:** SED = sédentaire, LPA =  activité physique légère, VPA = activité physique vigoureuse, MVPA = activité physique modérée à vigoureuse, NAP = niveau d'activité physique.
...
# Ratio MVPA / SED comment
  comment_ratio <- 
    ifelse(df1_means[["ratio_mvpa_sed"]] >= 0.04, "le patient obtient déjà la plupart des bénéfices de santé liés à son comportement physique",
