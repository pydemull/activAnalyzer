...
**Période journalière considérée pour évaluer le temps de port :** de `r params$start_day_analysis` à `r params$end_day_analysis`.
...
flextable::flextable(
 tibble::tribble(
    ...
    "Temps de port",                          paste0(round(df[["wear_time_revised"]], 0), " min"),
    "Nombre de jours valides",               paste0(df[["valid_days"]], " jour(s)"),
    "Kilocalories",                 paste0(format(round(df[["total_kcal"]], 2), nsmall = 2), " kcal"),
...
# Generate figure
  g_week <-
    ...
    tidyr::pivot_longer(cols = c(wear_time_revised, total_steps, pal, minutes_SED, minutes_LPA, minutes_MVPA, percent_SED, percent_LPA, percent_MVPA),
                        names_to = "variable", values_to = "value") %>%
    dplyr::mutate(variable = forcats::fct_relevel(variable, "wear_time_revised", "total_steps", "pal", 
                                   "minutes_MVPA", "minutes_LPA","minutes_SED", 
                                  "percent_MVPA", "percent_LPA", "percent_SED"),
                  variable = forcats::fct_recode(variable, 
                                 "Temps de port (min)" = "wear_time_revised", 
