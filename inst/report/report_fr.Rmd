...
**Période journalière considérée pour évaluer le temps de port valide :** de `r params$start_day_analysis` à `r params$end_day_analysis`.

**Nombre minimum d'heures avec temps de port valide pour valider un jour de mesure** : `r params$minimum_wear_time_for_analysis` heures.
