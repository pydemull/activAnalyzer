...
**Scores de quantité PROactive (pour patients BPCO) :** Score de pas = `r compute_pro_actigraph_score(df1_medians[["total_steps"]], metric = "steps")` (médiane journalière de `r df1_medians[["total_steps"]]` pas) ;  Score VMU = `r compute_pro_actigraph_score(df1_medians[["vm_per_min"]], metric = "vm")` (médiane journalière de `r df1_medians[["vm_per_min"]]` counts/min).
