...
To determine the intensity gradient, the app computes the number of minutes accumulated in 500 counts/min bins (e.g., 0-500, 501-1000, 1001-1500, ...). Then, a linear model is computed to describe the relation between the natural logarithm of the minutes accumulated in the bins, and the natural logarithm of the middle values of the correponding bins. The intensity gradient is the coefficient of the slope of this model [@rowlandsCutPointsAccelerometer2018].
