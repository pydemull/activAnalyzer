...
* `median bout duration (MBD)`: refers to the median sedentary (or physical activity) bout duration. MBD is computed using all the bouts of the days and periods of the day considered for analysis. MBD is computed using the following equation provided by Chastin et al. (2010; doi: 10.1016/j.gaitpost.2009.09.002): $MBD = 2^{1 / (\alpha - 1)x_{min}}$.
