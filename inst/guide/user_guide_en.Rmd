...
* `axis1_per_min`: mean of the counts per minute for the vertical axis (during the considered wear time only).
* `vm_per_min`: mean of the counts per minute for the vector magnitude (during the considered wear time only).
