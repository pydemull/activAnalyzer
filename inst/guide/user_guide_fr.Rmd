...
* `axis1_per_min:` moyenne des counts par minute pour l'axe vertical (durant la période où l'appareil était considéré comme porté seulement).
* `vm_per_min:` moyenne des counts par minute pour le vecteur magnitude (durant la période où l'appareil était considéré comme porté seulement).
