...
* Les kilocalories, en multipliant la valeur de MET par le MB exprimé en kcal/min pour les périodes non-SED (pour les périodes SED, le MB en kcal/min est directement utilisé) ;
