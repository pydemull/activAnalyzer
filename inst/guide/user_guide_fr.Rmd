...
* `axis1_per_min:` moyenne des counts par minute pour l'axe vertical (`total_counts_axis1` / 1440).
* `vm_per_min:` moyenne des counts par minute pour le vecteur magnitude (`total_counts_vm` / 1440).
