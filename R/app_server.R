...
app_server <- function(input, output, session) {
  ...
  # This comment was helpful to build the code: https://stackoverflow.com/questions/47728208/how-many-users-are-connected-to-my-shiny-application
  ...
  results_list <- eventReactive(input$Run, {
    ...
    # Adding variables of interest to the initial dataframe
      df_with_computed_metrics <-
        df() %>%
        mark_intensity(col_axis = cut_points()$axis_mvpa_chosen, 
  ...
  #########################################
    ...
    # Computing reactive PROactive accelerometer scores for C-PPAC
      
      # Score for steps count based on daily median
      ...
      # Score for VMU based on daily median
      ...
      # Score for steps count based on daily mean
      ...
      # Score for VMU based on daily mean
  ...
  # Showing PROactive accelerometer scores in tables for the week (C-PPAC) or for each day (D-PPAC)
        ...
        # C-PPAC (EN) / Steps: Based on the median metrics related to valid days
      ...
      if(is.na(steps_score_cppac_median())) {
        ...
        # C-PPAC (EN) / VMU: Based on the median metrics related to valid days
        ...
        # C-PPAC (EN) / Steps: Based on the mean metrics related to valid days
        ...
        # C-PPAC (EN) / VMU: Based on the mean metrics related to valid days
        ...
        # C-PPAC (FR) / Steps: Based on the median metrics related to valid days
        ...
        # C-PPAC (FR) / VMU: Based on the median metrics related to valid days
        ...
        # C-PPAC (FR) / Steps: Based on the mean metrics related to valid days
        ...
        # C-PPAC (FR) / VMU: Based on the mean metrics related to valid days
        ...
        # Getting PROactive final results: C-PPAC (EN)
            ...
            # Building reactive table of results
