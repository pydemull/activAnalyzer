...
if (language == "de") {
  ...
  if (metrics == "all") {
    selected_metrics <- c(
      ...
      "Höchstanzahl Schritte akk. 60 min (Schritte/min)",
      "Höchstanzahl Schritte akk. 30 min (Schritte/min)",
  ...
  plot <-
    ...
    variable = forcats::fct_recode(
      ...
      "Höchstanzahl Schritte akk. 60 min (Schritte/min)" ="peak_steps_60min", 
      "Höchstanzahl Schritte akk. 30 min (Schritte/min)" ="peak_steps_30min", 
