test_that("Gives correct comment about MPVA/SED ratio", {
  ...
  expect_match(comment_ratio_above_fr, "le patient pourrait probablement obtenir davantage de bénéfices de santé en replaçant du temps sédentaire par du temps d'activité physique")
